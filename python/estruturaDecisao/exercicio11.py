...
percentualAumento = salario * 0.15



print(f'Seu salário antes do reajuste: {salario}')
print(f'O percentual do aumento aplicado: {reajuste}')
print(f'O valor do aumento aplicado foi: {aumento}')
print(f'O novo salário aós o aumento: {novoSalario}')
